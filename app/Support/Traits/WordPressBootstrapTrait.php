...
use App\Support\WordPress;

trait WordPressBootstrapTrait
{
    /**
     *
     */
...
//                info('Exists: ' . $key);
     ...
     * @return string
     */
    protected function runAdminWithMenu($filename, array $globals = [])
    {
     ...
     * @return string
     */
    protected function runAdmin($filename, array $globals = [])
    {
     ...
     * @throws \Exception
     */
    protected function run($path, array $globals = [])
    {
